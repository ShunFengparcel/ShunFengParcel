...
type SfOrders struct {
	...
	OrderNo              string    `gorm:"column:order_no;type:varchar(100);comment:订单号;not null;" json:"order_no"`                                                                                                                               // 订单号
	...
	SenderAddress        string    `gorm:"column:sender_address;type:varchar(255);comment:寄件地址;not null;" json:"sender_address"`                                                                                                                  // 寄件地址
	...
	ReceiverAddress      string    `gorm:"column:receiver_address;type:varchar(255);comment:收件地址;not null;" json:"receiver_address"`                                                                                                              // 收件地址
	...
	IsInsured            int8      `gorm:"column:is_insured;type:tinyint(1);comment:是否保价 1是 2否;default:2;" json:"is_insured"`                                                                                                                     // 是否保价 1是 2否
	...
	ChargeWeight         float64   `gorm:"column:charge_weight;type:decimal(8, 3);comment:计费重量;->" json:"charge_weight"`                                                                                                                          // 计费重量（生成列，只读）
